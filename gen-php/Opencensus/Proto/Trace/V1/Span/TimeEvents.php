 ...
 *
 * Generated from protobuf message <code>opencensus.proto.trace.v1.Span.TimeEvents</code>
 */
class TimeEvents extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .opencensus.proto.trace.v1.Span.TimeEvent time_event = 1;</code>
     */
    private $time_event;
    /**
     ...
     *
     *     @type \Opencensus\Proto\Trace\V1\Span\TimeEvent[]|\Google\Protobuf\Internal\RepeatedField $time_event
     *           A collection of `TimeEvent`s.
     ...
     *
     * Generated from protobuf field <code>repeated .opencensus.proto.trace.v1.Span.TimeEvent time_event = 1;</code>
     * @param \Opencensus\Proto\Trace\V1\Span\TimeEvent[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTimeEvent($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Opencensus\Proto\Trace\V1\Span\TimeEvent::class);
        $this->time_event = $arr;
...
class_alias(TimeEvents::class, \Opencensus\Proto\Trace\V1\Span_TimeEvents::class);
