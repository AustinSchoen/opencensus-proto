...
namespace Opencensus\Proto\Trace\V1\Span\Link;
 ...
 *
 * Protobuf type <code>opencensus.proto.trace.v1.Span.Link.Type</code>
 */
class Type
{
    /**
...
class_alias(Type::class, \Opencensus\Proto\Trace\V1\Span_Link_Type::class);
